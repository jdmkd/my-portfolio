...
const Tech = () => {
  return (
    <div className="relative py-8 px-4 sm:px-8 bg-gradient-to-b from-black via-neutral-900 to-black" id="skills">
      ...
      {/* Skills Grid */}
      <div className="max-w-5xl mx-auto grid grid-cols-4 sm:grid-cols-5 md:grid-cols-7 gap-4 md:gap-6 px-4 sm:px-0">
        {techSkillsImg.map((item, index) => (
          ...
          >
            <div className="relative w-9 h-9 sm:w-20 sm:h-20 md:w-22 md:h-22 ">
              <Image
                src={item.imageUrl}
                alt="tech-skill"
                fill
