  ...
  return (
    ...
    <div className="section-technologies" id="tech">
        ...
        {techSkills.map((item, index) => (
            <div key={index} className='py-[1.5rem] lg:py-[2rem] px-[1rem] flex justify-center border border-gray-900/50 hover:border-gray-900/80 rounded-xl bg-slate-900/40 hover:bg-slate-900/90 transition-all text-white' key={item.id}>
