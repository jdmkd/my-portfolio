            ...
            <Link className=" py-[2rem] px-[2rem] border border-gray-700/70 bg-slate-900/70 shadow shadow-slate-300/20 rounded-md" href="./html-css-projects.html">
                <div className="flex flex-col items-start gap-[1rem]">
                    ...
                    <p className='tracking-wide'>
                        {`Spearheaded development initiatives for JERA, Japan's largest power generation company, contributing to the enhancement of critical systems that support the production of 30% of the nation's electricity.
