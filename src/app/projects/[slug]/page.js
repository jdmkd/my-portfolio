    ...
    return (
        <section className="min-h-screen bg-[#000000] text-white pt-32 pb-[6rem] px-6 font-sans selection:bg-white/20">
            <div className="max-w-[1400px] mx-auto">
                ...
                {/* Meta Info: Tech Stack & Links */}
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8 pb-6 border-t border-white/10">
                    {/* Tech Stack */}
                    ...
                    {/* Action Links */}
                    <div className="flex flex-col sm:flex-row lg:flex-col items-stretch sm:items-center lg:items-end gap-3 shrink-0 mt-6">
                        {project.live_demo && (
                            <a
                                href={project.live_demo}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full sm:w-[220px] flex items-center justify-center gap-3 py-3 px-8 text-sm font-bold text-black bg-white hover:bg-zinc-200 transition-all duration-300 shadow-[0_10px_20px_rgba(255,255,255,0.05)] hover:-translate-y-1"
                            >
                        ...
                        {isCodeAvailable(project) && (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full sm:w-[220px] flex items-center justify-center gap-3 py-3 px-8 text-sm font-bold text-white bg-transparent border border-white/20 hover:border-white hover:bg-white/5 transition-all duration-300"
                            >
                ...
                {project.images && project.images.length > 0 && (
                    <div className="w-full overflow-hidden shadow-[0_20px_50px_rgba(255,255,255,0.02)] border border-white/10 bg-[#050505] mb-20 relative">
